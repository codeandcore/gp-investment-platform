    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
            ...
            <div className="mt-4 space-y-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm">
                    Our committee will vet all applications over the next 4
                    weeks.
                  </div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm">
                    You will receive a decision via email by{" "}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm">
                    You can log back in at any time to update your public
                    database profile.
                  </div>
                </div>
              </div>
          ...
          <div className="mt-10 text-gray-400 text-sm text-center">
            ...
            <a
              className="text-blue-600 hover:underline underline-offset-4"
              href="mailto:support@raiseglobal.com"
            >
      ...
      <footer className="w-full py-8 text-center border-t border-gray-200 bg-white">
        <p className="text-sm text-gray-500">
          © 2025 RAISE Global Summit. All rights reserved.
        </p>
      </footer>
    </div>
  );
